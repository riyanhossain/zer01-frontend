...
import { changePositionStatus, deletePosition, getPositionsByOrderStatus } from "@/lib/api/position";
...
export default function Orders() {
    ...
    const { data } = useQuery({
        ...
        queryFn: () => getPositionsByOrderStatus({ search: Keywords }),
    });
    ...
    const handleStatusChange = (positionId) => {
        statusMutation.mutate({ positionId, status: "Active" });
    };
