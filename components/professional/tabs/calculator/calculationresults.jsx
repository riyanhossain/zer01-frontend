    ...
    return (
        <section className="my-5 py-6 bg-white shadow-[0px_4px_24px_rgba(122,122,122,0.1)] w-[1376px] lg:w-auto ">
            ...
            <div className=" mt-3 bg-[#F8F8F8] py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center justify-center">
                    <p className="font-inter font-medium">$5000</p>
                </div>
                <div className="flex items-center justify-center">
                    <p className="font-inter font-medium">$5000</p>
                </div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center">
                    <p className="font-inter ml-24">$113</p>
                </div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center">
                    <p className="font-inter ml-24">$489</p>
                </div>
                <div className="flex items-center justify-center"></div>
                ...
                <div className="flex items-center ">
                    <p className="font-inter ml-[50px]">$120</p>
                </div>
            </div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center">
                    <p className="font-inter ml-24">$1,222</p>
                </div>
                <div className="flex items-center justify-center"></div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center ">
                    <p className="font-inter ml-24">$615.00</p>
                </div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                <div className="pl-6">
                    <p className="font-inter ml-6">Net personal income</p>
                </div>
                <div className="flex items-center"></div>
                <div className="flex items-center "></div>
            ...
            <div className=" bg-[#F8F8F8] mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center"></div>
                <div className="flex items-center justify-center">
                    <p className="font-inter ml-24 text-[#434656]">$489</p>
                </div>
            ...
            <div className=" mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center ">
                    <p className="font-inter ml-24 text-[#434656]">$615.00</p>
                </div>
            ...
            <div className=" bg-[#F8F8F8] mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center"></div>
                <div className="flex items-center justify-center">
                    <p className="font-inter ml-24 text-[#434656]">$336.00</p>
                </div>
            ...
            <div className=" bg-[#F8F8F8] mt-3  py-2  grid grid-cols-[1fr_240px_240px_240px_150px]">
                ...
                <div className="flex items-center">
                    <p className="font-inter ml-[98px] text-[#434656]">$336.00</p>
                </div>
                <div className="flex items-center justify-center">
                    <p className="font-inter ml-24 text-[#434656]">$336.00</p>
                </div>
                ...
                <div className="flex items-center ">
                    <p className="font-inter ml-[50px] text-[#434656]">$336.00</p>
                </div>
            </div>
