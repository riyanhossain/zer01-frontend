    ...
    return (
        <section className="container mx-auto px-4 lg:px-8 xl:px-20 py-6 lg:py-12">
            ...
            <div className="p-6 shadow-[0px_4px_24px_rgba(122,122,122,0.1)]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[33%_1fr] gap-5 mt-5">
                    <label htmlFor="amount" className="flex flex-col ">
                        <span className="font-poppins text-sm">Gross amount per month</span>

                        <div className="flex items-center mt-2">
                            <section className="flex items-center p-2 gap-x-2 border-y border-l border-addgray bg-[#D9D9D933]">
                                <span className="font-inter">{currency}</span>

                                <select
                                    name="currency"
                                    id="currency"
                                    className="w-4 font-inter bg-transparent outline-none cursor-pointer"
                        ...
                        <div className="mt-6">
                            <button className="px-11 py-2.5 font-inter font-semibold text-white bg-primary hover:bg-opacity-80 active:bg-opacity-95">
                                Calculate
                            </button>
                        </div>
                    </label>
