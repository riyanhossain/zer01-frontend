...
import about2 from "../../../../assets/about/intro/about2.jpg";
        ...
        <section className="py-8 lg:py-12 container mx-auto px-4 lg:px-8 xl:px-20 ">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-5">
                <div className="relative">
                    <div className=" w-full lg:w-[336.02px] h-[290.48px] rounded-lg bg-primary hidden lg:block" />
                    <Image src={about2} className="w-[350.02px] h-[290.48px] absolute top-20 bottom-0 right-32 rounded-lg hidden lg:block" />
                ...
                <div className="space-y-4">
                    <h1 className="font-poppins text-addblack text-2xl lg:text-[32px] lg:leading-[42px] font-semibold w-full lg:w-[625px]">
                        We are <span className="text-primary">Zer01 CODE</span> the missing link between the new codegods and businesses.
                    </h1>

                    <p className="text-addgray font-inter w-full lg:w-[625px]">
                        Today’s way of working is obsolete!  Most organizations tend to be slow, still dreaming of farm cubicles, still run as
                        hierarchical command systems. All of this in a world of networked individuals and self-employed entrepreneurs. Pretty 1984,
                        huh?
                    </p>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Find the smart client for your <span className="text-primary">skills</span>
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Offer the <span className="text-primary">best</span> payment for your skills
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            <span className="text-primary">Freedom</span> to work from anywhere you chose
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Help you create your own <span className="text-primary">success</span> story
                        </p>
                    </div>
                </div>
            </div>
