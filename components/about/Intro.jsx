        ...
        <section className="container mx-auto px-4 lg:px-8 xl:px-20 py-6 lg:py-20 ">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-5">
                <div className="relative">
                    <Image src={about1} className=" w-full lg:w-[336.02px] h-[266.48px] rounded-lg hidden lg:block" style={{ position: "absolute", zIndex: "1" }}/>
                    <div className="w-[336.02px] h-[270.48px] absolute bottom-0 right-32 rounded-lg bg-primary hidden lg:block" style={{ zIndex: "0" }}/>
                    <div className="absolute bottom-10 left-24 hidden lg:block" style={{ position: "absolute", zIndex: "1" }}>
                ...
                <div className="space-y-4">
                    <h1 className="font-poppins text-addblack text-2xl lg:text-[32px] lg:leading-[42px] font-semibold w-full lg:w-[625px]">
                        <span className="text-primary">Zero1Code</span> is the outlink between professionals and businesses.
                    </h1>

                    <p className="text-addgray font-inter w-full lg:w-[625px]">
                        Outsourcing IT services, finding the right professionals for your project, finding the right clients, paying and being paid at the fair level, increasing efficiency, using the right resources, and focusing on what you do best, all these boxes will be checked by just turning to  <span className="text-primary">Zero1Code</span>.
                    </p>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Value by <span className="text-primary">pricing time and skills</span>
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Value for <span className="text-primary">professionals</span>
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Value for <span className="text-primary">businesses</span>
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-x-3">
                        ...
                        <p className="text-addblack text-lg font-inter">
                            Value for <span className="text-primary">society</span>
                        </p>
                    </div>
                </div>
            </div>
